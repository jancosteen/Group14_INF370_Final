...
{
    public partial class OrderMateContext2 : DbContext
    {
        public OrderMateContext2()
        {
        }

        public OrderMateContext2(DbContextOptions<OrderMateContext2> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<TableSeating> TableSeating { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.HasOne(d => d.ProductCategoryIdFkNavigation)
                    ...
                    .OnDelete(DeleteBehavior.SetNull);//remove this if nothing works
            ...
            {
                entity.HasKey(e => new { e.EmployeeIdFk, e.ProductIdFk })
            ...
            {
                entity.HasKey(e => new { e.TableIdFk, e.RestaurantIdFk })
                    .HasName("Restaurant_table_PK")
                    .IsClustered(false);

                entity.ToTable("Restaurant_Table");

                entity.Property(e => e.TableIdFk).HasColumnName("Table_Id_FK");
                ...
                entity.HasOne(d => d.RestaurantIdFkNavigation)
                    ...
                    .HasForeignKey(d => d.RestaurantIdFk)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("Table_1_Restaurant_FK_3");

                entity.HasOne(d => d.TableIdFkNavigation)
                    .WithMany(p => p.RestaurantTable)
                    .HasForeignKey(d => d.TableIdFk)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("Table_1_Table_FK");
            });

            modelBuilder.Entity<RestaurantTableStatus>(entity =>
            {
                entity.HasKey(e => e.RestaurantTableStatusId)
                    .HasName("PK_Table_1_Restaurant_Table_Status_Id")
                    .IsClustered(false);

                entity.ToTable("Restaurant_Table_Status");

                entity.HasIndex(e => e.RestaurantTableStatusId)
                    .HasName("UX_Table_1_Restaurant_Table_Status_Id")
                    .IsUnique();

                entity.Property(e => e.RestaurantTableStatusId).HasColumnName("Restaurant_Table_Status_Id");

                entity.Property(e => e.RestaurantIdFkFk).HasColumnName("Restaurant_Id_FK_FK");

                entity.Property(e => e.RestaurantTableStatus1)
                    .IsRequired()
                    .HasColumnName("Restaurant_Table_Status")
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.RestaurantTableStatusDateUpdated)
                    .HasColumnName("Restaurant_Table_Status_Date_Updated")
                    .HasMaxLength(10)
                    .IsFixedLength();

                entity.Property(e => e.TableIdFkFk).HasColumnName("Table_Id_FK_FK");

                entity.HasOne(d => d.RestaurantTable)
                    .WithMany(p => p.RestaurantTableStatus)
                    .HasForeignKey(d => new { d.TableIdFkFk, d.RestaurantIdFkFk })
                    .HasConstraintName("Restaurant_Table_Status_Restaurant_Table_FK");
            });
            ...
            modelBuilder.Entity<Table>(entity =>
            {
                entity.HasKey(e => e.TableId)
                    .HasName("PK_Table_1_Table_Id")
                    .IsClustered(false);

                entity.HasIndex(e => e.TableId)
                    .HasName("AK_Table_1_Table_Id")
                    .IsUnique();

                entity.Property(e => e.TableId).HasColumnName("Table_Id");

                entity.Property(e => e.TableNr).HasColumnName("Table_Nr");

                entity.Property(e => e.TableSeatQty).HasColumnName("Table_Seat_Qty");
            });

            modelBuilder.Entity<TableSeating>(entity =>
            {
                entity.HasKey(e => new { e.TableIdFkFk, e.RestaurantIdFkFk, e.UserIdFk, e.OrderIdFk })
                    .HasName("PK_Table_Seating_Table_Id_FK_FK_Restaurant_Id_FK_FK_User_Id_FK_Order_Id_FK")
                    .IsClustered(false);

                entity.ToTable("Table_Seating");
                ...
                entity.Property(e => e.TableSeatingDateTimeActiveFrom)
                    .HasColumnName("Table_Seating_DateTime_Active_From")
                    .HasColumnType("datetime");

                entity.Property(e => e.TableSeatingDateTimeActiveTo)
                    .HasColumnName("Table_Seating_DateTime_Active_To")
                    .HasColumnType("datetime");

                entity.Property(e => e.UserCommentIdFk).HasColumnName("User_Comment_Id_FK");

                entity.HasOne(d => d.OrderIdFkNavigation)
                    .WithMany(p => p.TableSeating)
                    .HasForeignKey(d => d.OrderIdFk)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("Table_Seating_Order_FK");

                entity.HasOne(d => d.ReservationIdFkNavigation)
                    .WithMany(p => p.TableSeating)
                    .HasForeignKey(d => d.ReservationIdFk)
                    .HasConstraintName("Table_Seating_Reservation_FK");

                entity.HasOne(d => d.UserCommentIdFkNavigation)
                    .WithMany(p => p.TableSeating)
                    .HasForeignKey(d => d.UserCommentIdFk)
                    .HasConstraintName("Table_Seating_User_Comment_FK");

                entity.HasOne(d => d.UserIdFkNavigation)
                    .WithMany(p => p.TableSeating)
                    .HasForeignKey(d => d.UserIdFk)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("Table_1_User_FK");

                entity.HasOne(d => d.RestaurantTable)
                    .WithMany(p => p.TableSeating)
                    .HasForeignKey(d => new { d.TableIdFkFk, d.RestaurantIdFkFk })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("Table_1_Restaurant_Table_FK");
            });
            ...
            modelBuilder.Entity<UserRole>(entity =>
            {
                entity.HasKey(e => e.UserRoleId)
                    .HasName("PK_Table_1_User_Role_Id")
                    .IsClustered(false);

                entity.ToTable("User_Role");

                entity.HasIndex(e => e.UserRole1)
                    .HasName("AK_Table_1_User_Role")
                    .IsUnique();

                entity.HasIndex(e => e.UserRoleId)
                    .HasName("AK_Table_1_User_Role_Id")
                    .IsUnique();
