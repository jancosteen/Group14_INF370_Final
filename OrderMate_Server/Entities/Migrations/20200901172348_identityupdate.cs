        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserRole1 = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Menu_Item_Category_Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Menu_Item_Category = table.Column<string>(fixedLength: true, maxLength: 10, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Hour_Of_Day = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "SalesByMenuItemReport",
                columns: table => new
                {
                    Menu_Item_Id = table.Column<int>(nullable: false),
                    Menu_Item_Name = table.Column<string>(nullable: true),
                    Menu_Item_Price = table.Column<double>(nullable: false),
                    Order_Date_Created = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                });
            ...
            migrationBuilder.CreateTable(
                name: "SalesByRestaurantReport",
                columns: table => new
                {
                    Menu_Item_Id = table.Column<int>(nullable: false),
                    Menu_Item_Name = table.Column<string>(nullable: true),
                    Menu_Item_Price = table.Column<double>(nullable: false),
                    Order_Date_Completed = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Supplier_Order_Date = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Advertisement_Id_FK = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Table_1_Advertisement_Date_Id", x => x.Advertisement_Date_Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
                        name: "Advertisement_Date_Advertisement_FK",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Table_1_Advertisement_Price_Id", x => x.Advertisement_Price_Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
                        name: "Advertisement_Price_Advertisement_FK",
                        column: x => x.Advertisement_Id_FK,
                        principalTable: "Advertisement",
                        principalColumn: "Advertisement_Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Restaurant_Coordinates = table.Column<string>(unicode: false, maxLength: 50, nullable: false),
                    ...
                    Restaurant_Address_Line_3 = table.Column<string>(unicode: false, maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Resaurant_Facility_Ref_PK", x => new { x.Restaurant_Facility_Id_FK, x.Restaurant_Id_FK })
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Res_Adv_1_PK", x => new { x.Restaurant_Id_FK, x.Advertisement_Id_FK })
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Retsaurant_Type_Ref_1_PK", x => new { x.Restaurant_Type_Id_FK, x.Restaurant_Id_FK })
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Social_Media_PK", x => new { x.Social_Media_Id, x.Social_Media_Type_Id_FK })
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
                        name: "Social_Media_Restaurant_FK",
                        column: x => x.Restaurant_Id_FK,
                        principalTable: "Restaurant",
                        principalColumn: "Restaurant_Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Table_1_Product_Id_FK_Supplier_Order_Id_FK", x => new { x.Product_Id_FK, x.Supplier_Order_Id_FK })
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    User_Surname = table.Column<string>(unicode: false, maxLength: 50, nullable: true),
                    User_Contact_Number = table.Column<string>(unicode: false, maxLength: 10, nullable: true),
                    User_Role_Id_FK = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Employee_Shift_PK", x => new { x.Shift_Id_FK, x.Employee_Id_FK })
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Product_Stock_Take_PK", x => new { x.Product_Id_FK, x.Stock_Take_Id_FK })
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Menu_Id_FK = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Menu_Item_item_Type_1_PK", x => new { x.Menu_Item_Id_FK, x.Menu_Item_Type_Id_FK })
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Item_Allergy_1_PK", x => new { x.Menu_Item_Id_FK, x.Allergy_Id_FK })
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Table_1_Menu_Item_Price_Id", x => x.Menu_Item_Price_Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
                        name: "Menu_Item_Price_Menu_Item_FK",
                        column: x => x.Menu_Item_Id_FK,
                        principalTable: "Menu_Item",
                        principalColumn: "Menu_Item_Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Menu_Item_Special_PK", x => new { x.Special_Id_FK, x.Menu_Item_Id_FK })
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("QrCode_Seating_PK", x => new { x.QrCode_Id_FK, x.SeatingId_FK })
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Advertisement_Date_Advertisement_Id_FK",
                table: "Advertisement_Date",
                column: "Advertisement_Id_FK");

            migrationBuilder.CreateIndex(
                name: "IX_Advertisement_Price_Advertisement_Id_FK",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Menu_Restaurant_Id_FK",
                table: "Menu",
                column: "Restaurant_Id_FK");

            migrationBuilder.CreateIndex(
                name: "IX_Menu_Item_Menu_Id_FK",
                table: "Menu_Item",
                column: "Menu_Id_FK");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Menu_Item_Price_Menu_Item_Id_FK",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Order_Line_Employee_Id_FK",
                table: "Order_Line",
                column: "Employee_Id_FK");
            ...
            migrationBuilder.CreateIndex(
                name: "AK_QrCode_Seating_QrCode_Id_FK",
                table: "QrCode_Seating",
                column: "QrCode_Id_FK",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Social_Media_Restaurant_Id_FK",
                table: "Social_Media",
                column: "Restaurant_Id_FK");
